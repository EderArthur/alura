const instrucao = prompt("Você pode selecionar a primeira opção digitando 1 e a segunda opção digitando 2!");
let instrucaoResposta = "";

if (instrucao == 1 ){
  instrucaoResposta = prompt("Otimo você entendeu!");
}
else if (instrucao == 2){
    linguagem = prompt("Otimo você entendeu!");
}
else {
    alert("Você não entendeu, leia novamente");
}
